    ...
    <header class="site-header navbar-sticky">
                ...
                <div class="search-box d-flex">
                    <div class="btn-group categories-btn">
                        ...
                        <div class="dropdown-menu mega-dropdown">
                          <div class="row">
                            <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo img_url('shop/header-categories/syringe.jpg'); ?>"><span class="text-gray-dark">Médicaments</span></a></div>
                    ...
                    <ul class="menu" data-initial-height="385">
                        ...
                        <li class="has-children"><span><a href="index.html">Recherche médicale</a><span class="sub-menu-toggle"></span></span>
                            <ul class="slideable-submenu">
                                ...
                                <li><a href="home-featured-categories.html">Pharmacie</a></li>
                        ...
                        <li class="has-children"><span><a href="<?php echo base_url().'accueil/monCompte' ?>">Mon compte</a><span class="sub-menu-toggle"></span></span>
                            <ul class="slideable-submenu">
                                <li class="active"><a href="index.html">Profil</a></li>
                                <li><a href="home-featured-categories.html">Se déconnecter</a></li>
                            </ul>
                        </li>
        ...
        <div class="navbar">
            <div class="btn-group categories-btn">
                ...
                <div class="dropdown-menu mega-dropdown">
                    <div class="row">
                      <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo img_url('shop/header-categories/syringe.jpg'); ?>"><span class="text-gray-dark">Médicament</span></a></div>
                      <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo img_url('shop/header-categories/heart.jpg'); ?>"><span class="text-gray-dark">Centre hospitalier</span></a></div>
                      ...
                      <div class="col-sm-3"><a class="d-block navi-link text-center mb-30" href="shop-grid-ls.html"><img class="d-block" src="<?php echo img_url('shop/header-categories/stethoscope.jpg'); ?>"><span class="text-gray-dark">Professionnels de santé</span></a></div>
                    </div>
                </div>
            </div>
                ...
                <ul>
                    ...
                    <li class="has-submenu"><a href="index.html">Recherche médicale</a>
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="home-featured-categories.html">Pharmacie</a>  
                            </li>
                    ...
                    <li class="has-submenu"><a href="index.html">Mon compte</a>
                        <ul class="sub-menu">
                            <li>
                            ...
                            <li>
                                <a href="home-featured-categories.html">Se déconnecter</a>  
                            </li>
                        </ul>
                    </li>
